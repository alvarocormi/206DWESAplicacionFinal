 ...
 */
// $oPreguntaAEditar = PreguntaPDO::buscaPreguntaPorCod($_SESSION['codPreguntaActual']);

// Almaceno la información del departamento actual en las siguiente variables, para mostrarlas en el formulario
if ($oPreguntaAEditar) {
    $codPreguntaAEditar = $oPreguntaAEditar->getCodDepartamento();
    $descripcionDepartamentoAEditar = $oPreguntaAEditar->getDescDepartamento();
    $fechaCreacionDepartamentoAEditar = $oPreguntaAEditar->getFechaCreacionDepartamento();
    $volumenNegocioAEditar = $oPreguntaAEditar->getVolumenDeNegocio();
}
