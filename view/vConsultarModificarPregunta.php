...
<div class="center" style="position: absolute; top: 48%; left: 50%; transform: translate(-50%, -50%);  border-radius: 5px; width: 440px; background: white; box-shadow: 10px 10px 15px rgba(0, 0, 0, 0.05); height: 610px;">
    ...
    <form name="formulario" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" style="margin-bottom: 20px; padding: 0 40px; box-sizing: border-box;">
        ...
        <div class="txt_field" style="position: relative; border-bottom: 2px solid #adadad; margin: 40px 0;">
            <input type="text" id="autorRespuestaAEditar" name="autorRespuestaAEditar" value="<?php echo ($autorRespuestaAEditar); ?>"  disabled style="width: 100%; padding: 0 5px; height: 40px; font-size: 16px; border: none; background: none; outline: none; background: lightgrey; color: white;">
            <span class="raya"></span>
