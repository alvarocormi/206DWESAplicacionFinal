...
<div class="center" style="position: absolute; top: 48%; left: 50%; transform: translate(-50%, -50%);  border-radius: 5px; width: 440px; background: white; box-shadow: 10px 10px 15px rgba(0, 0, 0, 0.05); height: 540px;">
